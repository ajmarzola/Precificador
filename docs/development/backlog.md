...
| UC026 — Consultar configurações de precificação da Empresa | UC | Pronto | — | [UC026-consultar-configuracoes-precificacao.md](../use-cases/UC026-consultar-configuracoes-precificacao.md) |
| UC027 — Alterar configurações de precificação da Empresa | UC | Especificado | UC026; revalidar após implementação | [UC027-alterar-configuracoes-precificacao.md](../use-cases/UC027-alterar-configuracoes-precificacao.md) |
