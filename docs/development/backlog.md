...
| MEL009 — Reserva comercial do Desconto de referência | MEL | Especificado | UC026, UC027, UC011 e UC012 | [MEL009](improvements/MEL009-reserva-comercial-desconto.md) |
...
| UC011 — Registrar preço de prateleira preservando snapshot de precificação | UC | Pronto | UC023; incorporar MEL009 | [UC011](../use-cases/UC011-registrar-preco-prateleira-snapshot.md) |
