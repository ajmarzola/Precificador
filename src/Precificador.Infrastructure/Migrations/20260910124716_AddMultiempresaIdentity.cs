...
{
    /// <inheritdoc />
    public partial class AddMultiempresaIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Empresas",
                columns: new[] { "Id", "Ativo", "Nome", "NomeNormalizado" },
                values: new object[] { 1, true, "Empresa inicial", "EMPRESA INICIAL" });
