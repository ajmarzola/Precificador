...
public sealed class InsumoTests
{
    ...
    {
        var insumo = Insumo.Criar(1, "Farinha", CategoriaInsumo.Ingrediente, UnidadeMedida.Grama);
    ...
    {
        var insumo = Insumo.Criar(1, "  Farinha   Renata  ", CategoriaInsumo.Ingrediente, UnidadeMedida.Grama);
    ...
    {
        var insumo = Insumo.Criar(1, "Açúcar", CategoriaInsumo.Ingrediente, UnidadeMedida.Grama);
    ...
    {
        Assert.Throws<ArgumentException>(() => Insumo.Criar(1, nome, CategoriaInsumo.Ingrediente, UnidadeMedida.Grama));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            Insumo.Criar(1, "Farinha", CategoriaInsumo.Ingrediente, (UnidadeMedida)0));
    }
}
